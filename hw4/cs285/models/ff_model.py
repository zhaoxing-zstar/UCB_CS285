...
from cs285.models.base_model import BaseModel, Prediction
...
class FFModel(nn.Module, BaseModel):
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        # outputs.
        next_obs_pred, _ = self(obs, acs, data_statistics['obs_mean'], data_statistics['obs_std'],
                                data_statistics['acs_mean'], data_statistics['acs_std'], data_statistics['delta_mean'],
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        # Hint: `self(...)` returns a tuple, but you only need to use one of the
        # outputs.
        _, delta_pred = self(observations, actions, data_statistics['obs_mean'], data_statistics['obs_std'],
                                data_statistics['acs_mean'], data_statistics['acs_std'], data_statistics['delta_mean'],
                                data_statistics['delta_std'])
        loss = self.loss(target, delta_pred)
        loss = loss.sum() / observations.shape[0]
